...
def filtering_input(feature_count_table, ref_feature_count_table,
                    filtered_ref_feature_count_table,
                    filtered_feature_count_table, column_to_drop):
...
def create_gene_quanti_table_modified(gene_quanti_table, column_to_drop):
    ...
    gene_quanti_table_modified = gene_quanti_table_with_gene_column_modified.drop(column_to_drop)
    return gene_quanti_table_modified
