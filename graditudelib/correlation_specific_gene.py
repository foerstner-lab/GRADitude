...
def correlation_specific_gene_against_all(feature_count_table, feature_count_start_column, feature_count_end_column,
    ...
    if correlation == "Spearman":
        spearman_correlation(gene_row_specific_gene, table_with_genes_new_index, output_file)
    else:
        pearson_correlation(gene_row_specific_gene, table_with_genes_new_index, output_file)
