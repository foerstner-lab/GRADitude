...
def pca(feature_count_table, feature_count_start_column,
        s_rna_list_files, output_file_colorized_by_clusters, output_file_colorized_by_rna_class,
    ...
    plot_t_sne_using_rna_classes_and_specific_list(feature_count_table_df, pca_result,
...
def plot_t_sne_using_rna_classes_and_specific_list(read_counting_table, pca_result,
                                               output_file_colorized_by_rna_class_and_list,
                                               srnas_and_list_names):
